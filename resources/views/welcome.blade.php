        ...
        <div class="flex flex-col justify-center px-24 py-28 max-md:px-5 max-md:py-24 place-items-center" role="region"
            ...
            <div class="flex flex-wrap gap-10 justify-between items-start max-w-full w-[1089px]">
                <div class="flex flex-col min-w-[240px] w-[645px] max-md:max-w-full">
                    ...
                    <button
                        class="flex flex-col justify-center px-7 py-5 mt-9 w-40 max-w-full text-base font-light leading-none text-blue-900 bg-white min-h-[52px] rounded-[40px] max-md:px-5 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-900"
                        aria-label="Get Started">
                        <div class="flex gap-2.5 w-full items-center">
                            <span>Get Started</span>
                            <img loading="lazy"
                                src="https://cdn.builder.io/api/v1/image/assets/TEMP/883f4a0eb9bff0b101aee0b2ee1ed99698bdb73b87738158384799f33d4ad162?apiKey=b1bd84c8cfcf466eb7283d9b13fee064&"
